...
public class HookMain {
    ...
    private HookMain(DamonParcel entity) {
        this.entity = entity;
    }
    ...
    public static void main(String[] strArr) {
        ...
        DamonParcel entity = DamonParcel.create(strArr[0]);
        if (entity != null) {
            new HookMain(entity).execute();
        }
    ...
    class DaemonRunnable implements Runnable {
        private WeakReference<HookMain> thiz;
        private int index;

        private DaemonRunnable(HookMain thiz, int index) {
